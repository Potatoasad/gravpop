...
class TestCompareToGwpopulation:
    ...
    def setup_method(self, method):
        ...
        self.redshift_grid = Grid1D(name='redshift', minimum=0, maximum=3.0, N=200).data

        self.gwpop_redshift_model = gwpopulation.models.redshift.PowerLawRedshift(z_max=3.0)
        self.gravpop_redshift_model = gravpop.PowerLawRedshift(z_max=3.0)
